...
insert  into `student`(`id`,`name`,`gender`,`age`,`jsp`,`servlet`,`address`) values (1,'张三','男','20',85,70,'沈阳大东'),(2,'李四','女',NULL,90,65,'沈阳大东'),(3,'王五','男','28',75,80,'沈阳沈河'),(4,'陈六','男','28',75,80,''),(5,'李七','男','30',64,83,NULL),(6,'李八八','男','35',67,82,'沈阳大东');
