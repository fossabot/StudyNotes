...
<body background="${pageContext.request.contextPath}/static/img/school.jpg" style=" background-repeat:no-repeat ;
...
<div class="col-xs-6 col-md-offset-3" style="padding-top: 100px;position: relative">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/readerAdd.html" method="post" id="readeredit" >
