...
$.ajax({
	...
	beforeSent：function(data){//发送请求前执行的代码}
	success：function(data){//发送请求成功后执行的代码}
...
```json
[
{"gtId":1,"gtName":"药品","id":1,"name":"红牛","price":76.5,"remarks":"挺好喝","stock":50},
{"gtId":1,"gtName":"药品","id":2,"name":"红霉素","price":76.5,"remarks":"见效快","stock":50},
{"gtId":1,"gtName":"商品","id":3,"name":"瓷砖","price":76.5,"remarks":"质量好","stock":50}
]
```
